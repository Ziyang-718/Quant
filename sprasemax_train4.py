...
# Use the original CrossEntropy loss instead of SparseMax
# This is to ensure the model starts learning properly
...
class Evaluator(keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs=None):
        ...
        # Only print minimal status to reduce callback overhead
...
with strategy.scope():
    ...
    # Use standard CrossEntropy for now to ensure the model trains properly
    ...
    # Configure optimizer with more standard parameters
    optimizer = AdamWLRG(
...
if __name__ == '__main__':
    ...
    # Minimize the callbacks to reduce overhead
